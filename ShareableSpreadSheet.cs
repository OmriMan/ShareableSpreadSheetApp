...
namespace Simulator
{
    class ShareableSpreadSheet
    {
        ...
        {//absolute writer
            ...
            for (int i = 0; i < this.rows; i++)
            {
                updatedGrid[i, col1] = ("New Column" + i + ",");
            }
            this.cols++;
        ...
        {//absolute writer
            ...
            else
            {
                ...
                //string[,] loadedGrid = new string[rows, cols];
                ...
                for (int i = 2; i < lines.Length; i++)
                {
                    ...
                    {
                        //loadedGrid[i - 2, x] = data[x];
                        loadedSpreadSheet.grid[i - 2, x] = data[x];
                    }
                ...
                this.setGrid(loadedSpreadSheet.grid);
                int z = 0;
